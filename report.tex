...
exact (*$\lambda$*) c d => h (and_intro c d)
\end{lstlisting}
...
\textbf{Solution:}
\begin{lstlisting}[escapeinside={(*}{*)},language=haskell]
exact (*$\lambda$*) cd => h (and_left cd) (and_right cd)
\end{lstlisting}
...
\textbf{Solution:}
\begin{lstlisting}[escapeinside={(*}{*)},language=haskell]
exact (*$\lambda$*) s => and_intro (and_left h s) (and_right h s)
\end{lstlisting}
...
\textbf{Solution:}
\begin{lstlisting}[escapeinside={(*}{*)},language=haskell]
exact (*$\lambda$*) r => and_intro ((*$\lambda$*) s => r) ((*$\lambda$*) _ => r)
\end{lstlisting}
